...
function purchase(){
	...
	//Prompt the user to make a purchase
		prompt.start();
		console.log("Please enter the ID number & quantity of the item you are interesting in purchasing.")
...
//****************
console.log("Thank you for shopping with Bamazon. Here is a menu of our available merchandise:");
displayAll();
purchase();
